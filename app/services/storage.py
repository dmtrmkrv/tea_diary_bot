...
# 1080 px (без апскейла на 3x-экранах при ширине карточки ~375 CSS px),
# качество 78 — ~65–160 КБ вместо 2–3.5 МБ оригинала. Качество превью в
# приоритете над экономией трафика (осознанный выбор).
THUMB_MAX_SIDE = 1080
THUMB_QUALITY = 78
