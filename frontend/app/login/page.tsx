...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Логотип — top: 138px по Figma */}
      <div className="relative flex justify-center pt-[138px]">
      ...
      <div className="relative flex flex-col items-center px-4 pb-[162px] text-white text-center">
        ...
        <div className="w-full max-w-[296px] flex flex-col gap-[12px] mt-[40px]">
          ...
          {showWidget && (
            <p className="text-[12px] leading-[16px] text-white/80 text-center">
